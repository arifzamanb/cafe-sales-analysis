...
## Dashboard
![Dashboard](Cafe%20Dashboard.png)
...
Busiest days based on sales select day_name, SUM(sales)
FROM `project-1b5d408f-99f4-4c24-a09.beginner_projects.cafe`
group by day_name;

Impact of wait time on customer ratings SELECT
  CASE
